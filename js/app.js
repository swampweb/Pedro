...
window.pedroGame=(()=>{
  ...
  function setPhase(value,label){phase=value;$('#phase-badge').textContent=label;$('#center-phase').textContent=label.replace('WAITING FOR PLAYERS','WAITING');$('#table-status').textContent=label.replace('WAITING FOR ','')}
